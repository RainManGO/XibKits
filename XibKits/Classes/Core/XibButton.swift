...
open class XibButton: UIButton {
     ...
     **/
    open var badgeAnchor : XibAnchor = .TopRight(topOffset: 0.0, rightOffset: 0.0){
        didSet{
            setupBadgeViewWithString(badgeText: badgeString)
        }
    }
    ...
    open func initWithFrame(frame: CGRect, withBadgeString badgeString: String, withBadgeInsets badgeInsets: UIEdgeInsets, badgeAnchor : XibAnchor = .TopRight(topOffset: 0.0, rightOffset: 0.0)) -> AnyObject {
    ...
    fileprivate func setupBadgeViewWithString(badgeText: String?){
        ...
        if let label = titleLabel  {
            insertSubview(badgeLabel, aboveSubview: label)
        }else{
            addSubview(badgeLabel)
        }
        
        insertSubview(badgeLabel, at: 99999)
